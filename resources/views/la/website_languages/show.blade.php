...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $website_language->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Website_languages", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/website_languages/'.$website_language->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Website_languages", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.website_languages.destroy', $website_language->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/website_languages') }}" data-toggle="tooltip" data-placement="right" title="Back to Website languages"><i class="fa fa-chevron-left"></i></a></li>
