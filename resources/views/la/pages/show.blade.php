			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'title_tw')
						@la_display($module, 'banner')
						@la_display($module, 'intro_en')
						@la_display($module, 'intro_tw')
						@la_display($module, 'meta_title_en')
						@la_display($module, 'meta_title_tw')
						@la_display($module, 'meta_description_en')
						@la_display($module, 'meta_description_tw')
						@la_display($module, 'meta_keyword_en')
						@la_display($module, 'meta_keyword_tw')
					</div>
				</div>
			</div>
		</div>
