...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $service_detail->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Service_details", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/service_details/'.$service_detail->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Service_details", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.service_details.destroy', $service_detail->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/service_details') }}" data-toggle="tooltip" data-placement="right" title="Back to Service details"><i class="fa fa-chevron-left"></i></a></li>
