			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'decimal')
						@la_display($module, 'dropdown')
						@la_display($module, 'email')
						@la_display($module, 'file')
						@la_display($module, 'float')
						@la_display($module, 'html')
						@la_display($module, 'image')
						@la_display($module, 'integer')
						@la_display($module, 'mobile')
						@la_display($module, 'multiselect')
						@la_display($module, 'name')
						@la_display($module, 'password')
						@la_display($module, 'radio')
						@la_display($module, 'string')
						@la_display($module, 'taginput')
						@la_display($module, 'textarea')
						@la_display($module, 'textfield')
						@la_display($module, 'url')
						@la_display($module, 'multi_file')
					</div>
				</div>
			</div>
		</div>
