	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $about->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Abouts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/abouts/'.$about->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Abouts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.abouts.destroy', $about->id], 'method' => 'delete', 'style'=>'display:inline']) }}
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'connect')
						@la_display($module, 'connect_img')
						@la_display($module, 'people')
						@la_display($module, 'people_slogan')
						@la_display($module, 'people_img')
						@la_display($module, 'case')
						@la_display($module, 'case_img')
