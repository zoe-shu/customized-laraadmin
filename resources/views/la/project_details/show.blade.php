...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_detail->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_details", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_details/'.$project_detail->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_details", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_details.destroy', $project_detail->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_details') }}" data-toggle="tooltip" data-placement="right" title="Back to Project details"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'proj_title')
						@la_display($module, 'address')
						@la_display($module, 'map_lat')
						@la_display($module, 'map_lon')
						@la_display($module, 'type')
						@la_display($module, 'size')
						@la_display($module, 'agents')
						@la_display($module, 'summary')
						@la_display($module, 'url')
						@la_display($module, 'meta_title')
						@la_display($module, 'meta_desc')
						@la_display($module, 'meta_key')
