...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $crg_user->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Crg_users", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/crg_users/'.$crg_user->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Crg_users", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.crg_users.destroy', $crg_user->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/crg_users') }}" data-toggle="tooltip" data-placement="right" title="Back to Crg users"><i class="fa fa-chevron-left"></i></a></li>
